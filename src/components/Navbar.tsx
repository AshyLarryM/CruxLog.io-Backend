...
export function Navbar() {
    ...
    return (
        <header className='flex items-center justify-center h-[75px] w-full z-50 bg-slate-900 text-black'>
            <div className="relative flex justify-between items-center max-w-screen-xl w-full px-5 z-50">
                <Link href="/">
                    <div className="flex items-center cursor-pointer">
                        <img src="/assets/logos/musiclogo.png" alt="Nerve Lab Logo" className="md:h-12 h-10 pb-2" />
                    </div>
                </Link>
