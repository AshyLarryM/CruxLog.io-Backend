            ...
            <div className="flex justify-center items-center py-1">
                <div className="flex flex-row w-full 2xl:flex justify-center">
                    <div className="w-1/2 flex flex-col justify-between">
                        <div>
                            <h1 className="animate-fade-in text-center 2xl:text-left text-6xl font-semibold mb-4 mt-0 sm:mt-36 bg-gradient-to-b from-bright-yellow via-[#F34971] to-primary-purple bg-clip-text text-transparent">
